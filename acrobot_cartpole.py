...
class PolicyNetwork:
    def __init__(self, state_size, action_size, learning_rate, name='policy_network'):
        ...
        with tf.variable_scope(name):
            ...
            with tf.variable_scope('acrobot_policy'):
...
writer = tf.summary.FileWriter('acrobot_cartpole/output')
...
with tf.Session() as sess:
    ...
    saver = tf.train.Saver({'acrobot_policy/W1': policy.W1, 'acrobot_policy/b1': policy.b1,
                            'acrobot_policy/W2': policy.W2, 'acrobot_policy/b2': policy.b2})
    saver.restore(sess, "models/acrobot_expert.ckpt")
