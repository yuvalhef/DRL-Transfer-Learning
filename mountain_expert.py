...
bin = (env.action_space.high[0] - env.action_space.low[0])/action_size
discrete_actions = np.array(list(range(int(env.action_space.low[0]*action_size),
                                       int(env.action_space.high[0]*action_size+1), int(bin*action_size))))/action_size
...
checkpoint_path = "models/mountaincar.ckpt"
...
writer = tf.summary.FileWriter('mountain_expert/output')
